...
const STATUS_CONFIG: Record<RoutingStatus, StatusColorConfig> = {
  ...
  return (
    ...
    >
      ...
      <Box flexDirection="row" justifyContent="space-between" alignItems="center" marginBottom="y12">
        ...
        {showStatus && (
          <Box
            ...
            borderRadius="s8"
          >
            <Text preset="text12" fontWeightPreset="semibold" color={statusConfig.textColor}>
              {statusConfig.label}
            </Text>
          </Box>
        )}
      ...
      <Box flexDirection="row" flexWrap="wrap" gap="x12">
        ...
        <Text preset="text14" fontWeightPreset="semibold" color="primary100">
          {preco}
        </Text>
