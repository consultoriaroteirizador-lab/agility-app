...
export function LoginBody({ controller }: Props) {
    ...
    useEffect(() => {
        // Aguardar carregamento das credenciais antes de decidir mostrar card ou input
    ...
    }, [reset, setIsEmailField, setShowMultipleAccounts, userCredentialsList, tenantInfo, isLoadingCredentials]);
