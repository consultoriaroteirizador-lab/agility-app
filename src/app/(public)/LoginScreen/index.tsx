  ...
  return (
    <ScreenBase scrollable mtScreenBase='t0' mbScreenBase='b0' marginHorizontalScreenBase='x0' >
      <Box backgroundColor='white' flexDirection='row' justifyContent='space-between' width={"100%"}>
        <Box borderBottomRightRadius='s40' width={measure.x140} height={measure.y110} borderBottomWidth={measure.m1} borderRightWidth={measure.m1} borderColor='primary100' />
        <Box borderBottomLeftRadius='s40' borderBottomRightRadius='s10' width={measure.x200} height={measure.y110} borderBottomWidth={measure.m1} borderLeftWidth={measure.m1} borderColor='primary100' />
      </Box>
      <Box
