...
import type { CreateTicketPayload, UpdateTicketPayload } from './dto/types'
import {
  create,
  findOne,
  findByNumber,
...
export async function createTicketService(payload: CreateTicketPayload): Promise<BaseResponse<TicketItem>> {
...
export async function updateTicketService(id: Id, payload: UpdateTicketPayload): Promise<BaseResponse<TicketItem>> {
