    ...
    <LocationTrackingProvider>
      <Box flex={1} px="x16" pt="y12" pb="y24">
        ...
        {aba === 'concluido' && (
          <Box gap="y24">
            <Box>
              <Text preset="text15" fontWeightPreset='bold' color="gray500" mb="y8">
                ...
                {paradasConcluidas
                  ...
                  .map((p) => (
                    <Box
                      ...
                      opacity={0.6}
                    >
                      <Text preset="text16" fontWeightPreset='semibold' color="colorTextPrimary" mb="y4">
                ...
                {paradasConcluidas
                  ...
                  .map((p) => (
                    <Box
                      ...
                      opacity={0.6}
                    >
                      <Text preset="text16" fontWeightPreset='semibold' color="redError" mb="y4">
                        Parada {p.numero} - {p.nome}
                      </Text>
                      <Text preset="text13" color="gray400">
                        {p.endereco}
