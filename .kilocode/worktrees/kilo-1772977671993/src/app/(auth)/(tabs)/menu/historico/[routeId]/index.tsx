  ...
  return (
    <Box flex={1} backgroundColor="white">
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Header */}
        <Box paddingHorizontal="x16" paddingTop="y12" paddingBottom="y16">
        ...
        <Box
          ...
          alignItems="center"
        >
          <Text preset="text14" color="gray400">Mapa da rota</Text>
        </Box>

        {/* Resumo */}
        <Box paddingHorizontal="x16" marginBottom="y16">
          <Box
            flexDirection="row"
            flexWrap="wrap"
            gap="x12"
        ...
        {/* Lista de servicos */}
        <Box paddingHorizontal="x16" paddingBottom="y24">
