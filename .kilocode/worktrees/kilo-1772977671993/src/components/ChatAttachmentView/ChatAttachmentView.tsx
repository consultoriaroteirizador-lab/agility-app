...
import { Box, Text, ModalComponent, TouchableOpacityBox } from '@/components';
...
export default function ChatAttachmentView({
  ...
  return (
    <>
      ...
      <ModalComponent
        visible={selectedImageIndex !== null && attachments[selectedImageIndex!]?.type === 'image'}
        onRequestClose={() => setSelectedImageIndex(null)}
        animationType="fade"
        dismissable={true}>
          <Box flex={1} backgroundColor="rgba(0,0,0,0.9)" alignItems="center" justifyContent="center">
